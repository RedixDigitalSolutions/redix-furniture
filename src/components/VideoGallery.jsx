...
import { furnitureVideos } from '../data/data';
...
const VideoGallery = () => {
    ...
    const clients = [...new Set(furnitureVideos.map(video => video.client))];
    const types = [...new Set(furnitureVideos.map(video => video.type))];

    const filteredVideos = furnitureVideos.filter(video => {
        ...
        <section id="videos" className={styles.gallery}>
            <div className={styles.container}>
                <div className={styles.header}>
                    <h2 className={styles.title}>Furniture Video Portfolio</h2>
                    <p className={styles.subtitle}>
                        Showcasing our best video content for home furniture and interior design businesses
                    </p>
                </div>
                ...
                <div className={styles.resultCount}>
                    Showing {filteredVideos.length} of {furnitureVideos.length} videos
                </div>
